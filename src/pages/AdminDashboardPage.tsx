...
import { AdminTripGoTab } from "../components/admin/AdminTripGoTab";
...
type Tab = "agencies" | "bookings" | "tripgo" | "services" | "resale" | "notifications";
...
export function AdminDashboardPage() {
  ...
  const tabs: { key: Tab; label: string }[] = [
    ...
    { key: "services", label: "الخدمات الإضافية" },
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "tripgo" ? <AdminTripGoTab /> : null}
      {tab === "services" ? <AdminServicesTab /> : null}
