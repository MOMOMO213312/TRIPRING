...
export function BlueFridayPage() {
  ...
  return (
    <div className="-mx-4 -my-8 bg-surface-warm pb-16 sm:mx-0 sm:my-0">
      {/* Ticker */}
      <div dir="ltr" className="ticker-viewport flex items-center overflow-hidden bg-navy py-2 text-xs font-bold text-white">
...
function TimeBox({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <div className="font-latin flex size-16 items-center justify-center rounded-xl bg-navy text-2xl font-extrabold text-white">
        {value}
      </div>
    ...
    >
      ...
      <div className="p-3">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="font-latin text-lg font-extrabold text-primary">${deal.price}</span>
