...
const SERVICE_KEYWORDS: Record<PackageServiceKey, string[]> = {
  ...
  lounge: ["صالة", "lounge"],
  fast_track: ["fast track", "فاست تراك", "fast-track"],
  meet_assist: ["meet", "assist", "استقبال", "مرافقة"],
...
export const SERVICE_PACKAGES: ServicePackageDef[] = [
  {
    ...
    icon: "👑",
    badge: "الأشمل",
    includedKeys: ["transfer", "lounge", "fast_track", "meet_assist"],
  ...
  },
  {
    ...
    icon: "👨‍👩‍👧‍👦",
    includedKeys: ["transfer", "baggage", "meet_assist"],
