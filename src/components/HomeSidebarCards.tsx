  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-1 flex items-center gap-2">
        <span className="flex size-8 items-center justify-center rounded-full bg-primary-light text-primary" aria-hidden>
          🔔
        </span>
      ...
      <Link
        to="/alerts"
        className="mb-3 block w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm font-medium text-slate-500 transition hover:border-primary"
      >
        CAI - DXB
      </Link>
      <Link
        to="/alerts"
        className="block w-full rounded-xl bg-navy py-2.5 text-center text-sm font-bold text-white transition hover:bg-slate-800"
      >
        إنشاء تنبيه
      </Link>
    </div>
...
export function BudgetTeaserCard() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-1 flex items-center gap-2">
        <span className="flex size-8 items-center justify-center rounded-full bg-primary-glow text-primary" aria-hidden>
          💰
        </span>
