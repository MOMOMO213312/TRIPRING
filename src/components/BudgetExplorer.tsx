    ...
    <section>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="flex min-w-[100px] flex-1 flex-col items-center justify-center gap-1 rounded-xl border border-slate-200 bg-white px-4 py-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#FF7A45] hover:shadow-md sm:flex-none"
        >
