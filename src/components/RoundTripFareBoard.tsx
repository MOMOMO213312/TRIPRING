...
export function RoundTripFareBoard({ deals, references, airports }: Props) {
  ...
  return (
    <div
      dir="ltr"
      className="ticker-viewport relative isolate flex h-12 w-full items-stretch overflow-hidden bg-[#3BB8E0] sm:h-14"
    >
      <div className="relative z-10 flex shrink-0 items-center gap-1.5 whitespace-nowrap border-e border-white/30 bg-[#0E7BA6] px-4 py-2.5 text-xs font-extrabold leading-none text-white">
