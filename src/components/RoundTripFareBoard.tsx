...
export function RoundTripFareBoard({ deals, references, airports }: Props) {
  ...
  return (
    <div
      dir="ltr"
      className="ticker-viewport relative isolate flex h-12 w-full items-stretch overflow-hidden bg-gradient-to-r from-[#00C9BC] to-[#00877E] sm:h-14"
    >
      <div className="relative z-10 flex shrink-0 items-center gap-2 whitespace-nowrap border-e border-white/30 bg-[#00877E] px-4 py-2.5 text-xs font-extrabold leading-none text-white">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-14 z-10 w-8 bg-gradient-to-r from-[#00C9BC] to-transparent sm:left-16" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-8 bg-gradient-to-l from-[#00877E] to-transparent" />
    </div>
  );
}
