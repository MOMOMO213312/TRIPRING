...
export function OneWayFareBoard({ deals, references, airports }: Props) {
  ...
  return (
    <div
      dir="ltr"
      className="ticker-viewport relative isolate flex h-12 w-full items-stretch overflow-hidden bg-[#00B7AC] sm:h-14"
    >
      ...
      <div className="pointer-events-none absolute inset-y-0 left-14 z-10 w-8 bg-gradient-to-r from-[#00B7AC] to-transparent sm:left-16" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-8 bg-gradient-to-l from-[#00B7AC] to-transparent" />
    </div>
  );
}
