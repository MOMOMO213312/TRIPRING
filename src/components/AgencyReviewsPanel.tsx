          ...
          {() => (
            <form onSubmit={handleSubmit} className="mt-4 space-y-3 border-t border-slate-100 pt-4">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none transition focus:border-accent focus:ring-2 focus:ring-[#FFD9C2]"
              />
